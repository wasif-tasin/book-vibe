...
const BookDetailsPage = async ({ params }: IBookDetailsPageProps) => {
    ...
    <figure className="lg:w-2/5 bg-base-200 p-6">
        <Image
            ...
            height={500}
            width={300}
            className="h-100 w-auto rounded-xl object-cover shadow-lg"
        />
    </figure>
    ...
    <div className="card-body lg:w-3/5 p-6 lg:p-8">
        ...
        <div className="card-actions mt-6 justify-end">
            <button className="btn btn-primary px-8 shadow-md hover:shadow-lg">
                Read
            </button>
            <button className='btn btn-primary px-8 shadow-md hover:shadow-lg'>Whishlist</button>
        </div>
